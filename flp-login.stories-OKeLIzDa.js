...
`,s=T.bind({});s.args=S;var f,u,h;s.parameters={...s.parameters,docs:{...(f=s.parameters)==null?void 0:f.docs,source:{originalSource:`(props: Login, {
  globals: {
    theme
  }
}: {
...
//# sourceMappingURL=flp-login.stories-OKeLIzDa.js.map
