 ...
 * @tag flp-button
 */
 @customElement("flp-button")
export class FlpButton extends FlpElement implements FlpFormControl {
  ...
  /**
   * Draws a circular icon button. When this attribute is present, the button expects a single `<flp-icon>` in the
   * default slot.
   */
