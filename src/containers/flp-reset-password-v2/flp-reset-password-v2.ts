...
import { flippico } from '../flp-reset-password/flp-reset-password.styles';
import { ifDefined } from 'lit/directives/if-defined.js';

/**
 * @summary Reset password v2 — uses base_url attribute for API calls
 * @tag flp-reset-password-v2
 */
@customElement("flp-reset-password-v2")
export class FlpResetPasswordV2 extends FlpElement {
  ...
  async onSubmitHandle(event: any) {
    ...
    this.errorText = null;
    fetch(`${this.baseUrl}/api/${this.tenantKey}/reset-password`, {
      method: "POST",
      body: urlencoded,
      headers: {
