...
import { flippico } from "../flp-signup/flp-signup.styles";
import { ifDefined } from "lit/directives/if-defined.js";

/**
 * @summary Signup v2 component — with provider_id support
 * @tag flp-signup-v2
 */
@customElement("flp-signup-v2")
export class FlpSignupV2 extends FlpElement {
  ...
  onSubmitHandle(event: any) {
    ...
    fetch(`/api/${this.tenantKey}/signup`, {
      method: "POST",
      body: urlencoded,
      headers: myHeaders,
    })
      ...
      .then((response) => {
        ...
        window.parent.postMessage(
          { type: "SIGNUP_SUCCESS", payload: response.message },
          "*",
        );
    ...
    return html`<flp-card class="auth-container">
      <form @submit=${this.onSubmitHandle}>
        ...
        <flp-input
          class="mb-medium"
          name="password"
          help-text="Minimum 8 znaków oraz minimum dwie liczby"
          required
          type="password"
          label="Hasło"
          password-toggle
        ...
        <div class="login-container">
          ...
          <flp-button class="login--button" variant="text" href=${this.loginUrl}
