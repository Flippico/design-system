import{i as k,x as f}from"./lit-element-BOnOm6HC.js";import{F as C,t as O}from"./custom-element-G_of5crQ.js";import{n as m}from"./property-DtfuD-FT.js";import{e as u}from"./query-BApjzB0v.js";import{c as P}from"./component.styles-BRPzpB69.js";import{H as $}from"./slot-BCTpRhJ5.js";import{M as A}from"./modal-raw-bfnOvLZK.js";import{l as g,u as v}from"./scroll-Xz6hnXoZ.js";import{g as r,a as n,s as p,w as y}from"./event-DI7budSv.js";import{o as b}from"./if-defined-4aLJvHj9.js";import{a as D}from"./class-map-CkhaUZsQ.js";import{w as S}from"./watch-CEsCE2EF.js";/* empty css             */import"./flp-button-BUnE6aW6.js";import"./tabbable-BIdkFw3w.js";import"./state-BzG7ktrc.js";import"./form-JvG0YwJe.js";const E=k`
${P}
...
`;var q=Object.defineProperty,F=Object.getOwnPropertyDescriptor,i=(e,o,t,s)=>{for(var l=s>1?void 0:s?F(o,t):o,c=e.length-1,h;c>=0;c--)(h=e[c])&&(l=(s?h(o,t,l):h(l))||l);return s&&l&&q(o,t,l),l};let a=class extends C{constructor(){super(...arguments),this.hasSlotController=new $(this,"footer"),this.modal=new A(this),this.open=!1,this.label="",this.noHeader=!1,this.handleDocumentKeyDown=e=>{e.key==="Escape"&&this.modal.isActive()&&this.open&&(e.stopPropagation(),this.requestClose("keyboard"))}}firstUpdated(){this.dialog.hidden=!this.open,this.open&&(this.addOpenListeners(),this.modal.activate(),g(this))}disconnectedCallback(){super.disconnectedCallback(),this.modal.deactivate(),v(this)}requestClose(e){if(this.emit("flp-request-close",{cancelable:!0,detail:{source:e}}).defaultPrevented){const t=r(this,"dialog.denyClose",{dir:"ltr"});n(this.panel,t.keyframes,t.options);return}this.hide()}addOpenListeners(){document.addEventListener("keydown",this.handleDocumentKeyDown)}removeOpenListeners(){document.removeEventListener("keydown",this.handleDocumentKeyDown)}async handleOpenChange(){if(this.open){this.emit("flp-show"),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.modal.activate(),g(this);const e=this.querySelector("[autofocus]");e&&e.removeAttribute("autofocus"),await Promise.all([p(this.dialog),p(this.overlay)]),this.dialog.hidden=!1,requestAnimationFrame(()=>{this.emit("flp-initial-focus",{cancelable:!0}).defaultPrevented||(e?e.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),e&&e.setAttribute("autofocus","")});const o=r(this,"dialog.show",{dir:"ltr"}),t=r(this,"dialog.overlay.show",{dir:"ltr"});await Promise.all([n(this.panel,o.keyframes,o.options),n(this.overlay,t.keyframes,t.options)]),this.emit("flp-after-show")}else{this.emit("flp-hide"),this.removeOpenListeners(),this.modal.deactivate(),await Promise.all([p(this.dialog),p(this.overlay)]);const e=r(this,"dialog.hide",{dir:"ltr"}),o=r(this,"dialog.overlay.hide",{dir:"ltr"});await Promise.all([n(this.overlay,o.keyframes,o.options).then(()=>{this.overlay.hidden=!0}),n(this.panel,e.keyframes,e.options).then(()=>{this.panel.hidden=!0})]),this.dialog.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1,v(this);const t=this.originalTrigger;typeof(t==null?void 0:t.focus)=="function"&&setTimeout(()=>t.focus()),this.emit("flp-after-hide")}}async show(){if(!this.open)return this.open=!0,y(this,"flp-after-show")}async hide(){if(this.open)return this.open=!1,y(this,"flp-after-hide")}render(){return f`
    ...
    `}};a.styles=[E];i([u(".dialog")],a.prototype,"dialog",2);i([u(".dialog__panel")],a.prototype,"panel",2);i([u(".dialog__overlay")],a.prototype,"overlay",2);i([m({type:Boolean,reflect:!0})],a.prototype,"open",2);i([m({reflect:!0})],a.prototype,"label",2);i([m({attribute:"no-header",type:Boolean,reflect:!0})],a.prototype,"noHeader",2);i([S("open",{waitUntilFirstUpdate:!0})],a.prototype,"handleOpenChange",1);a=i([O("flp-modal")],a);const Z={title:"components/Modal",component:"flp-modal"},L={},M=(e,{globals:{theme:o}})=>f`
...
}`,...(w=(x=d.parameters)==null?void 0:x.docs)==null?void 0:w.source}}};const ee=["Default"];export{d as Default,ee as __namedExportsOrder,Z as default};
//# sourceMappingURL=flp-modal.stories-CKCOO--r.js.map
