import{i as v,k as g}from"./lit-element-CPYlYYac.js";import{c as d,F as h,t as b}from"./component.styles-CJs1ohMC.js";import{n as i}from"./property-CcHbFR6H.js";import{R as y}from"./class-map-635SZfYW.js";/* empty css             */const _=v`
${d}
...
`;var w=Object.defineProperty,x=Object.getOwnPropertyDescriptor,l=(n,t,s,o)=>{for(var r=o>1?void 0:o?x(t,s):t,p=n.length-1,c;p>=0;p--)(c=n[p])&&(r=(o?c(t,s,r):c(r))||r);return o&&r&&w(t,s,r),r};let a=class extends h{constructor(){super(...arguments),this.variant="neutral",this.size="medium",this.pill=!1,this.removable=!1}handleRemoveClick(){this.emit("flp-remove")}render(){return g`
      <span
        part="base"
    ...
    `}};a.styles=[_];l([i({reflect:!0})],a.prototype,"variant",2);l([i({reflect:!0})],a.prototype,"size",2);l([i({type:Boolean,reflect:!0})],a.prototype,"pill",2);l([i({type:Boolean})],a.prototype,"removable",2);a=l([b("flp-tag")],a);const R={title:"components/Tag",component:"flp-tag"},z={},P=(n,{globals:{theme:t}})=>g`
...
`,e=P.bind({});e.args=z;var f,u,m;e.parameters={...e.parameters,docs:{...(f=e.parameters)==null?void 0:f.docs,source:{originalSource:`(props: Tag, {
  globals: {
    theme
  }
}: {
...
\``,...(m=(u=e.parameters)==null?void 0:u.docs)==null?void 0:m.source}}};const $=["Default"];export{e as Default,$ as __namedExportsOrder,R as default};
//# sourceMappingURL=flp-tag.stories-DqfnTIo8.js.map
