import{i as p,x as d}from"./lit-element-w72SgdYd.js";import{H as f}from"./slot-zZ9PctTm.js";import{F as h,t as v}from"./custom-element-fmFNofkQ.js";import{n as r}from"./property-ok3xJcRr.js";import{r as c}from"./state-su1Uxz9_.js";import{e as g}from"./query-dBZnW-oo.js";import{c as m}from"./dark-VEljs8KV.js";import{F as y,v as _}from"./form-WhrKCMSX.js";import{o as n}from"./if-defined-QFQtpYAo.js";import{w as x}from"./watch-jbmnu0Mo.js";import{a as w}from"./class-map-YdTWFbRy.js";const k=p`
  ${m}
...
`;var C=Object.defineProperty,B=Object.getOwnPropertyDescriptor,o=(l,a,u,i)=>{for(var e=i>1?void 0:i?B(a,u):a,s=l.length-1,b;s>=0;s--)(b=l[s])&&(e=(i?b(a,u,e):b(e))||e);return i&&e&&C(a,u,e),e};let t=class extends h{constructor(){super(...arguments),this.formControlController=new y(this,{assumeInteractionOn:["click"]}),this.hasSlotController=new f(this,"[default]","prefix","suffix"),this.hasFocus=!1,this.invalid=!1,this.title="",this.variant="default",this.size="medium",this.caret=!1,this.disabled=!1,this.loading=!1,this.outline=!1,this.pill=!1,this.circle=!1,this.type="button",this.name="",this.value="",this.href="",this.rel="noreferrer noopener"}get validity(){return this.isButton()?this.button.validity:_}get validationMessage(){return this.isButton()?this.button.validationMessage:""}firstUpdated(){this.isButton()&&this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("flp-blur")}handleFocus(){this.hasFocus=!0,this.emit("flp-focus")}handleClick(){this.type==="submit"&&this.formControlController.submit(this),this.type==="reset"&&this.formControlController.reset(this)}handleInvalid(l){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(l)}isButton(){return!this.href}isLink(){return!!this.href}handleDisabledChange(){this.isButton()&&this.formControlController.setValidity(this.disabled)}click(){this.button.click()}focus(l){this.button.focus(l)}blur(){this.button.blur()}checkValidity(){return this.isButton()?this.button.checkValidity():!0}getForm(){return this.formControlController.getForm()}reportValidity(){return this.isButton()?this.button.reportValidity():!0}setCustomValidity(l){this.isButton()&&(this.button.setCustomValidity(l),this.formControlController.updateValidity())}render(){const l=this.isLink();return d`
      <button
        part="base"
