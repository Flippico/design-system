import{i as $,T as y,w as z,x as h}from"./lit-element-w72SgdYd.js";import{F as D,t as T}from"./custom-element-fmFNofkQ.js";import{n}from"./property-ok3xJcRr.js";import{r as u}from"./state-su1Uxz9_.js";import{e as f}from"./query-dBZnW-oo.js";import{c as L}from"./dark-VEljs8KV.js";import{f as A}from"./form-control.styles-tuYxVhS3.js";import{H as E}from"./slot-zZ9PctTm.js";import{F}from"./form-WhrKCMSX.js";import{d as V}from"./default-value-rc7TTEY0.js";import{i as P,t as B,e as M,a as g}from"./class-map-YdTWFbRy.js";import{w as m}from"./watch-jbmnu0Mo.js";import{b as I,s as _,g as x,a as w,w as O}from"./event-WBR2e-ql.js";import{s as H}from"./scroll-txGY1VcM.js";import"./flp-icon-XMFsXchT.js";import"./directive-helpers-ZATOk6x_.js";const j=$`
  ${L}
  ${A}
 ...
 */class v extends P{constructor(t){if(super(t),this.et=y,t.type!==B.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===y||t==null)return this.vt=void 0,this.et=t;if(t===z)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.et)return this.vt;this.et=t;const l=[t];return l.raw=l,this.vt={_$litType$:this.constructor.resultType,strings:l,values:[]}}}v.directiveName="unsafeHTML",v.resultType=1;const K=M(v);var U=Object.defineProperty,q=Object.getOwnPropertyDescriptor,o=(e,t,l,s)=>{for(var a=s>1?void 0:s?q(t,l):t,p=e.length-1,r;p>=0;p--)(r=e[p])&&(a=(s?r(t,l,a):r(a))||a);return s&&a&&U(t,l,a),a};let i=class extends D{constructor(){super(...arguments),this.formControlController=new F(this,{assumeInteractionOn:["flp-blur","flp-input"]}),this.hasSlotController=new E(this,"help-text","label"),this.typeToSelectString="",this.hasFocus=!1,this.displayLabel="",this.selectedOptions=[],this.name="",this.value="",this.defaultValue="",this.size="medium",this.placeholder="",this.multiple=!1,this.maxOptionsVisible=3,this.disabled=!1,this.clearable=!1,this.open=!1,this.hoist=!1,this.filled=!1,this.pill=!1,this.label="",this.placement="bottom",this.helpText="",this.form="",this.required=!1,this.getTag=e=>h`
      <flp-tag
        part="tag"
        exportparts="
              base:tag__base,
...
`;var R=Object.defineProperty,W=Object.getOwnPropertyDescriptor,d=(e,t,l,s)=>{for(var a=s>1?void 0:s?W(t,l):t,p=e.length-1,r;p>=0;p--)(r=e[p])&&(a=(s?r(t,l,a):r(a))||a);return s&&a&&R(t,l,a),a};let c=class extends D{constructor(){super(...arguments),this.current=!1,this.selected=!1,this.hasHover=!1,this.value="",this.disabled=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.setAttribute("aria-selected","false")}handleDefaultSlotChange(){const e=this.getTextLabel();if(typeof this.cachedTextLabel>"u"){this.cachedTextLabel=e;return}e!==this.cachedTextLabel&&(this.cachedTextLabel=e,this.emit("slotchange",{bubbles:!0,composed:!1,cancelable:!1}))}handleMouseEnter(){this.hasHover=!0}handleMouseLeave(){this.hasHover=!1}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleSelectedChange(){this.setAttribute("aria-selected",this.selected?"true":"false")}handleValueChange(){typeof this.value!="string"&&(this.value=String(this.value)),this.value.includes(" ")&&(console.error("Option values cannot include a space. All spaces have been replaced with underscores.",this),this.value=this.value.replace(/ /g,"_"))}getTextLabel(){return(this.textContent??"").trim()}render(){return h`
      <div
        part="base"
...
//# sourceMappingURL=flp-select.stories-gVZcibjR.js.map
