import{i as $,w as b,T as z,u as w,x as c}from"./lit-element-w72SgdYd.js";import{F as I,t as V}from"./custom-element-fmFNofkQ.js";import{c as A,b as P,i as B,t as u,e as E,r as S,n as l,w as v,F as D,H as F,a as g,o as s}from"./dark-fop_Y-vI.js";import{f as O,m as U}from"./directive-helpers-Yey3jZal.js";const R=$`
 ...
 */const N=P(class extends B{constructor(t){if(super(t),t.type!==u.PROPERTY&&t.type!==u.ATTRIBUTE&&t.type!==u.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!O(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[o]){if(o===b||o===z)return o;const r=t.element,n=t.name;if(t.type===u.PROPERTY){if(o===r[n])return b}else if(t.type===u.BOOLEAN_ATTRIBUTE){if(!!o===r.hasAttribute(n))return b}else if(t.type===u.ATTRIBUTE&&r.getAttribute(n)===o+"")return b;return U(t),o}}),H=(t="value")=>(o,r)=>{const n=o.constructor,a=n.prototype.attributeChangedCallback;n.prototype.attributeChangedCallback=function(p,d,_){const m=n.getPropertyOptions(t),T=typeof m.attribute=="string"?m.attribute:t;if(p===T){const h=m.converter||w,y=(typeof h=="function"?h:(h==null?void 0:h.fromAttribute)??w.fromAttribute)(_,m.type);this[t]!==y&&(this[r]=y)}a.call(this,p,d,_)}};var j=Object.defineProperty,K=Object.getOwnPropertyDescriptor,i=(t,o,r,n)=>{for(var a=n>1?void 0:n?K(o,r):o,p=t.length-1,d;p>=0;p--)(d=t[p])&&(a=(n?d(o,r,a):d(a))||a);return n&&a&&j(o,r,a),a};let e=class extends I{constructor(){super(...arguments),this.formControlController=new D(this,{assumeInteractionOn:["flp-blur","flp-input"]}),this.hasSlotController=new F(this,"help-text","label"),this.hasFocus=!1,this.title="",this.__numberInput=Object.assign(document.createElement("input"),{type:"number"}),this.__dateInput=Object.assign(document.createElement("input"),{type:"date"}),this.type="text",this.name="",this.value="",this.defaultValue="",this.size="medium",this.filled=!1,this.pill=!1,this.label="",this.helpText="",this.clearable=!1,this.disabled=!1,this.placeholder="",this.readonly=!1,this.passwordToggle=!1,this.passwordVisible=!1,this.noSpinButtons=!1,this.form="",this.required=!1,this.spellcheck=!0}get valueAsDate(){var t;return this.__dateInput.type=this.type,this.__dateInput.value=this.value,((t=this.input)==null?void 0:t.valueAsDate)||this.__dateInput.valueAsDate}set valueAsDate(t){this.__dateInput.type=this.type,this.__dateInput.valueAsDate=t,this.value=this.__dateInput.value}get valueAsNumber(){var t;return this.__numberInput.value=this.value,((t=this.input)==null?void 0:t.valueAsNumber)||this.__numberInput.valueAsNumber}set valueAsNumber(t){this.__numberInput.valueAsNumber=t,this.value=this.__numberInput.value}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("flp-blur")}handleChange(){this.value=this.input.value,this.emit("flp-change")}handleClearClick(t){this.value="",this.emit("flp-clear"),this.emit("flp-input"),this.emit("flp-change"),this.input.focus(),t.stopPropagation()}handleFocus(){this.hasFocus=!0,this.emit("flp-focus")}handleInput(){this.value=this.input.value,this.formControlController.updateValidity(),this.emit("flp-input")}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}handleKeyDown(t){const o=t.metaKey||t.ctrlKey||t.shiftKey||t.altKey;t.key==="Enter"&&!o&&setTimeout(()=>{!t.defaultPrevented&&!t.isComposing&&this.formControlController.submit()})}handlePasswordToggle(){this.passwordVisible=!this.passwordVisible}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleStepChange(){this.input.step=String(this.step),this.formControlController.updateValidity()}async handleValueChange(){await this.updateComplete,this.formControlController.updateValidity()}focus(t){this.input.focus(t)}blur(){this.input.blur()}select(){this.input.select()}setSelectionRange(t,o,r="none"){this.input.setSelectionRange(t,o,r)}setRangeText(t,o,r,n="preserve"){const a=o??this.input.selectionStart,p=r??this.input.selectionEnd;this.input.setRangeText(t,a,p,n),this.value!==this.input.value&&(this.value=this.input.value)}showPicker(){"showPicker"in HTMLInputElement.prototype&&this.input.showPicker()}stepUp(){this.input.stepUp(),this.value!==this.input.value&&(this.value=this.input.value)}stepDown(){this.input.stepDown(),this.value!==this.input.value&&(this.value=this.input.value)}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(t){this.input.setCustomValidity(t),this.formControlController.updateValidity()}render(){const t=this.hasSlotController.test("label"),o=this.hasSlotController.test("help-text"),r=this.label?!0:!!t,n=this.helpText?!0:!!o,a=this.clearable&&!this.disabled&&!this.readonly,p=a&&(typeof this.value=="number"||this.value.length>0);return c`
      <div
        part="form-control"
...
\``,...(C=(k=f.parameters)==null?void 0:k.docs)==null?void 0:C.source}}};const Z=["Default"];export{f as Default,Z as __namedExportsOrder,X as default};
//# sourceMappingURL=flp-input.stories-7IYN6CW_.js.map
