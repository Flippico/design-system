 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function M(e,t){return(r,o,n)=>{const a=l=>{var d;return((d=l.renderRoot)==null?void 0:d.querySelector(e))??null};if(t){const{get:l,set:d}=typeof o=="object"?r:n??(()=>{const c=Symbol();return{get(){return this[c]},set(h){this[c]=h}}})();return C(r,o,{get(){let c=l.call(this);return c===void 0&&(c=a(this),(c!==null||this.hasUpdated)&&d.call(this,c)),c}})}return C(r,o,{get(){return a(this)}})}}class N{constructor(t,...r){this.slotNames=[],this.handleSlotChange=o=>{const n=o.target;(this.slotNames.includes("[default]")&&!n.name||n.name&&this.slotNames.includes(n.name))&&this.host.requestUpdate()},(this.host=t).addController(this),this.slotNames=r}hasDefaultSlot(){return[...this.host.childNodes].some(t=>{if(t.nodeType===t.TEXT_NODE&&t.textContent.trim()!=="")return!0;if(t.nodeType===t.ELEMENT_NODE){const r=t;if(r.tagName.toLowerCase()==="flp-visually-hidden")return!1;if(!r.hasAttribute("slot"))return!0}return!1})}hasNamedSlot(t){return this.host.querySelector(`:scope > [slot="${t}"]`)!==null}test(t){return t==="[default]"?this.hasDefaultSlot():this.hasNamedSlot(t)}hostConnected(){this.host.shadowRoot.addEventListener("slotchange",this.handleSlotChange)}hostDisconnected(){this.host.shadowRoot.removeEventListener("slotchange",this.handleSlotChange)}}const P=F`
  :host {
 ...
 */const G=X(class extends Y{constructor(e){var t;if(super(e),e.type!==H.ATTRIBUTE||e.name!=="class"||((t=e.strings)==null?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){var o,n;if(this.it===void 0){this.it=new Set,e.strings!==void 0&&(this.st=new Set(e.strings.join(" ").split(/\s/).filter(a=>a!=="")));for(const a in t)t[a]&&!((o=this.st)!=null&&o.has(a))&&this.it.add(a);return this.render(t)}const r=e.element.classList;for(const a of this.it)a in t||(r.remove(a),this.it.delete(a));for(const a in t){const l=!!t[a];l===this.it.has(a)||(n=this.st)!=null&&n.has(a)||(l?(r.add(a),this.it.add(a)):(r.remove(a),this.it.delete(a)))}return U}});var J=Object.defineProperty,K=Object.getOwnPropertyDescriptor,s=(e,t,r,o)=>{for(var n=o>1?void 0:o?K(t,r):t,a=e.length-1,l;a>=0;a--)(l=e[a])&&(n=(o?l(t,r,n):l(n))||n);return o&&n&&J(t,r,n),n};let i=class extends L{constructor(){super(...arguments),this.formControlController=new R(this,{assumeInteractionOn:["click"]}),this.hasSlotController=new N(this,"[default]","prefix","suffix"),this.hasFocus=!1,this.invalid=!1,this.title="",this.variant="default",this.size="medium",this.caret=!1,this.disabled=!1,this.loading=!1,this.outline=!1,this.pill=!1,this.circle=!1,this.type="button",this.name="",this.value="",this.href="",this.rel="noreferrer noopener"}get validity(){return this.isButton()?this.button.validity:w}get validationMessage(){return this.isButton()?this.button.validationMessage:""}firstUpdated(){this.isButton()&&this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("flp-blur")}handleFocus(){this.hasFocus=!0,this.emit("flp-focus")}handleClick(){this.type==="submit"&&this.formControlController.submit(this),this.type==="reset"&&this.formControlController.reset(this)}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}isButton(){return!this.href}isLink(){return!!this.href}handleDisabledChange(){this.isButton()&&this.formControlController.setValidity(this.disabled)}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}checkValidity(){return this.isButton()?this.button.checkValidity():!0}getForm(){return this.formControlController.getForm()}reportValidity(){return this.isButton()?this.button.reportValidity():!0}setCustomValidity(e){this.isButton()&&(this.button.setCustomValidity(e),this.formControlController.updateValidity())}render(){const e=this.isLink();return e?V`a`:V`button`,y`
    ...
    `}};i.styles=[j];s([M(".button")],i.prototype,"button",2);s([B()],i.prototype,"hasFocus",2);s([B()],i.prototype,"invalid",2);s([u()],i.prototype,"title",2);s([u({reflect:!0})],i.prototype,"variant",2);s([u({reflect:!0})],i.prototype,"size",2);s([u({type:Boolean,reflect:!0})],i.prototype,"caret",2);s([u({type:Boolean,reflect:!0})],i.prototype,"disabled",2);s([u({type:Boolean,reflect:!0})],i.prototype,"loading",2);s([u({type:Boolean,reflect:!0})],i.prototype,"outline",2);s([u({type:Boolean,reflect:!0})],i.prototype,"pill",2);s([u({type:Boolean,reflect:!0})],i.prototype,"circle",2);s([u()],i.prototype,"type",2);s([u()],i.prototype,"name",2);s([u()],i.prototype,"value",2);s([u()],i.prototype,"href",2);s([u()],i.prototype,"target",2);s([u()],i.prototype,"rel",2);s([u()],i.prototype,"download",2);s([u()],i.prototype,"form",2);s([u({attribute:"formaction"})],i.prototype,"formAction",2);s([u({attribute:"formenctype"})],i.prototype,"formEnctype",2);s([u({attribute:"formmethod"})],i.prototype,"formMethod",2);s([u({attribute:"formnovalidate",type:Boolean})],i.prototype,"formNoValidate",2);s([u({attribute:"formtarget"})],i.prototype,"formTarget",2);s([q("disabled",{waitUntilFirstUpdate:!0})],i.prototype,"handleDisabledChange",1);i=s([T("flp-button")],i);const rt={title:"components/Button",component:"flp-button"},Q={},Z=(e,{globals:{theme:t}})=>y`
  <div>
...
`,v=Z.bind({});v.args=Q;var E,$,S;v.parameters={...v.parameters,docs:{...(E=v.parameters)==null?void 0:E.docs,source:{originalSource:`(props: Button, {
  globals: {
    theme
  }
}: {
...
\``,...(S=($=v.parameters)==null?void 0:$.docs)==null?void 0:S.source}}};const et=["Default"];export{v as Default,et as __namedExportsOrder,rt as default};
//# sourceMappingURL=flp-button.stories-K6YkV7iT.js.map
