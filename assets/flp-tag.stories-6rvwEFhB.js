import{i as v,x as g}from"./lit-element-w72SgdYd.js";import{F as d,t as h}from"./custom-element-fmFNofkQ.js";import{n as i}from"./property-ok3xJcRr.js";import{c as b}from"./dark-VEljs8KV.js";import{a as y}from"./class-map-YdTWFbRy.js";const _=v`
${b}
...
`;var w=Object.defineProperty,x=Object.getOwnPropertyDescriptor,l=(n,t,s,o)=>{for(var r=o>1?void 0:o?x(t,s):t,p=n.length-1,c;p>=0;p--)(c=n[p])&&(r=(o?c(t,s,r):c(r))||r);return o&&r&&w(t,s,r),r};let a=class extends d{constructor(){super(...arguments),this.variant="neutral",this.size="medium",this.pill=!1,this.removable=!1}handleRemoveClick(){this.emit("flp-remove")}render(){return g`
    ...
    `}};a.styles=[_];l([i({reflect:!0})],a.prototype,"variant",2);l([i({reflect:!0})],a.prototype,"size",2);l([i({type:Boolean,reflect:!0})],a.prototype,"pill",2);l([i({type:Boolean})],a.prototype,"removable",2);a=l([h("flp-tag")],a);const $={title:"components/Tag",component:"flp-tag"},z={},P=(n,{globals:{theme:t}})=>g`
...
\``,...(m=(u=e.parameters)==null?void 0:u.docs)==null?void 0:m.source}}};const C=["Default"];export{e as Default,C as __namedExportsOrder,$ as default};
//# sourceMappingURL=flp-tag.stories-6rvwEFhB.js.map
