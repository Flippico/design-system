import{i as x,k as b}from"./lit-element-CPYlYYac.js";import{l as h}from"./index-fCdhHCjk.js";import{F as k,t as w}from"./custom-element-DcGDOd3C.js";import{n as a}from"./property-CcHbFR6H.js";import{r as y}from"./state-Cw-lAQBx.js";import{F as _}from"./flp-icon-MB4vJ9eU.js";import{a as v}from"./index-D-l25SpK.js";import{F as $}from"./flp-spinner-y5zgyz0m.js";import{t as c}from"./if-defined-4GS2c12S.js";import{g as m}from"./get-api-url-BNamD47E.js";/* empty css             */import"./flp-card-CdUiWKie.js";import"./component.styles-MQe3hEw3.js";import"./slot-BCTpRhJ5.js";import"./class-map-635SZfYW.js";import"./flp-button-DKNOhfQI.js";import"./query-BApjzB0v.js";import"./form-DpMOf5Do.js";import"./watch-CEsCE2EF.js";import"./flp-input-DnWocktz.js";import"./form-control.styles-qMh6M_JA.js";import"./live-DyBFC1nW.js";import"./directive-helpers-CHX3h6dV.js";import"./default-value-DEpNiEhc.js";import"./flp-logo-BmvhRZ3J.js";import"./flp-divider-CYuWwxR4.js";import"./commonjsHelpers-Cpj98o6Y.js";h({tagName:"flp-icon",elementClass:_,react:v,events:{},displayName:"FlpIcon"});h({tagName:"flp-spinner",elementClass:$,react:v,events:{},displayName:"FlpSpinner"});const P=x`
...
`;var C=Object.defineProperty,F=Object.getOwnPropertyDescriptor,o=(n,l,e,s)=>{for(var i=s>1?void 0:s?F(l,e):l,p=n.length-1,g;p>=0;p--)(g=n[p])&&(i=(s?g(l,e,i):g(i))||i);return s&&i&&C(l,e,i),i};let t=class extends k{constructor(){super(...arguments),this.tenantKey="",this.loginCallback="",this.logoutCallback="",this.name="",this.staging=!1,this.develop=!1,this.loginPending=!1}async loginByGoogle(){console.log("login by google")}async loginByApple(){console.log("login by apple")}async onSubmitHandle(n){n.preventDefault(),this.loginPending=!0;const l=new FormData(n.target);if(Array.from(l.values()).some(e=>e==="")){this.errorText="Password or email is empty",this.loginPending=!1;return}this.errorText=null,fetch(`${m(this.staging,this.develop)}/api/${this.tenantKey}/login`,{method:"POST",body:l,headers:{"Content-Type":"application/x-www-form-urlencoded"}}).then(e=>e.json()).then(e=>{window.location.replace(`${this.loginCallback}/${e.message.token}`)}).catch(()=>this.errorText="Error while send to API").finally(()=>this.loginPending=!1)}render(){return b`
    ...
    </flp-card>`}};t.styles=[P];o([a({type:String,attribute:"tenant_key"})],t.prototype,"tenantKey",2);o([a({type:String,attribute:"login_callback"})],t.prototype,"loginCallback",2);o([a({type:String,attribute:"logout_callback"})],t.prototype,"logoutCallback",2);o([a({type:String,attribute:"name"})],t.prototype,"name",2);o([a({type:Boolean,attribute:"staging"})],t.prototype,"staging",2);o([a({type:Boolean,attribute:"develop"})],t.prototype,"develop",2);o([y()],t.prototype,"errorText",2);o([y()],t.prototype,"loginPending",2);t=o([w("flp-login")],t);const lt={title:"containers/Login",component:"flp-login"},S={},D=(n,{globals:{theme:l}})=>b`
...
//# sourceMappingURL=flp-login.stories-4zZvbe9t.js.map
