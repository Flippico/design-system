...
`;var w=Object.defineProperty,P=Object.getOwnPropertyDescriptor,l=(i,a,t,e)=>{for(var o=e>1?void 0:e?P(a,t):a,s=i.length-1,m;s>=0;s--)(m=i[s])&&(o=(e?m(a,t,o):m(o))||o);return e&&o&&w(a,t,o),o};let n=class extends y{constructor(){super(...arguments),this.tenantKey="",this.loginCallback="",this.logoutCallback="",this.name="",this.staging=!1,this.develop=!1,this.loginPending=!1}onSubmitHandle(i){i.preventDefault(),this.loginPending=!0;const a=new FormData(i.target);if(Array.from(a.values()).some(e=>e==="")){this.loginPending=!1;return}const t=new URLSearchParams;t.append("tenant_key",this.tenantKey),t.append("login_callback",this.loginCallback),t.append("logout_callback",this.logoutCallback),t.append("name",a.get("name")),t.append("email",a.get("email")),t.append("password",a.get("password")),fetch(`${c(this.staging,this.develop)}/api/${this.tenantKey}/signup`,{method:"POST",body:t,headers:{"Content-Type":"application/x-www-form-urlencoded"}}).then(e=>{console.log(e),e.status>=300&&e.status<400&&(window.location.href=e.headers.get("Location"))}).finally(()=>this.loginPending=!1)}render(){return b`<flp-card class="auth-container">
...
//# sourceMappingURL=flp-signup.stories-BREcIVRs.js.map
