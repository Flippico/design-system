...
`;var $=Object.defineProperty,S=Object.getOwnPropertyDescriptor,i=(r,e,n,o)=>{for(var l=o>1?void 0:o?S(e,n):e,m=r.length-1,g;m>=0;m--)(g=r[m])&&(l=(o?g(e,n,l):g(l))||l);return o&&l&&$(e,n,l),l};let t=class extends y{constructor(){super(...arguments),this.tenantKey="",this.logo="",this.signUpUrl="",this.resetPasswordUrl="",this.staging=!1,this.develop=!1,this.mobileLogin=!1,this.loginPending=!1}async loginByGoogle(){window.location.href='bajkomat://login?token="sds"'}async loginByApple(){console.log("login by apple")}async onSubmitHandle(r){r.preventDefault(),this.loginPending=!0;const e=new FormData(r.target);if(Array.from(e.values()).some(o=>o==="")){this.errorText="Password or email is empty",this.loginPending=!1;return}const n=new URLSearchParams;n.append("tenant_key",this.tenantKey),n.append("name",e.get("name")),n.append("email",e.get("email")),n.append("password",e.get("password")),this.errorText=null,fetch(`${P(this.staging,this.develop)}/api/${this.tenantKey}/login`,{method:"POST",body:n,headers:{"Content-Type":"application/x-www-form-urlencoded"}}).then(o=>o.json()).then(o=>{window.location.href=o.message.redirect_url}).catch(console.error).finally(()=>this.loginPending=!1)}render(){return p`
...
//# sourceMappingURL=flp-login.stories-Bbjiv-xk.js.map
