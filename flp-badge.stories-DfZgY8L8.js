import{i as b,k as f}from"./lit-element-CPYlYYac.js";import{F as m,t as v}from"./custom-element-DcGDOd3C.js";import{n as c}from"./property-CcHbFR6H.js";import{c as h}from"./component.styles-MQe3hEw3.js";import{R as y}from"./class-map-635SZfYW.js";/* empty css             */const w=b`
${h}
...
`;var x=Object.defineProperty,_=Object.getOwnPropertyDescriptor,s=(t,a,n,o)=>{for(var e=o>1?void 0:o?_(a,n):a,p=t.length-1,i;p>=0;p--)(i=t[p])&&(e=(o?i(a,n,e):i(e))||e);return o&&e&&x(a,n,e),e};let r=class extends m{constructor(){super(...arguments),this.variant="primary",this.pill=!1,this.pulse=!1}render(){return f`
    ...
    `}};r.styles=[w];s([c({reflect:!0})],r.prototype,"variant",2);s([c({type:Boolean,reflect:!0})],r.prototype,"pill",2);s([c({type:Boolean,reflect:!0})],r.prototype,"pulse",2);r=s([v("flp-badge")],r);const R={title:"components/Badge",component:"flp-badge"},B={},P=(t,{globals:{theme:a}})=>f`
...
\``,...(u=(g=l.parameters)==null?void 0:g.docs)==null?void 0:u.source}}};const S=["Default"];export{l as Default,S as __namedExportsOrder,R as default};
//# sourceMappingURL=flp-badge.stories-DfZgY8L8.js.map
