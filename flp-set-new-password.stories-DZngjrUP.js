import{i as u,x as i}from"./lit-element-UdLzEcH-.js";import{F as y,t as b}from"./custom-element-_dbbq29R.js";import{n as p}from"./property-Cw6hBOl6.js";import{r as m}from"./state-DfeXbQig.js";import{o as c}from"./if-defined-CeGyAtVP.js";import{g as x}from"./get-api-url-BNamD47E.js";/* empty css             */const v=u`
flp-button {
  width: 100%;
}
.error {
...
`;var P=Object.defineProperty,_=Object.getOwnPropertyDescriptor,o=(n,e,r,t)=>{for(var a=t>1?void 0:t?_(e,r):e,d=n.length-1,g;d>=0;d--)(g=n[d])&&(a=(t?g(e,r,a):g(a))||a);return t&&a&&P(e,r,a),a};let s=class extends y{constructor(){super(...arguments),this.tenantKey="",this.token="",this.logo="",this.staging=!1,this.develop=!1,this.loginPending=!1,this.successState=!1}async onSubmitHandle(n){n.preventDefault(),this.loginPending=!0;const e=new FormData(n.target);if(Array.from(e.values()).some(t=>t==="")){this.errorText="Password is empty",this.loginPending=!1;return}const r=new URLSearchParams;if(!/^(?=.*\d.*\d)[A-Za-z\d]{6,}$/.test(e.get("password"))){this.errorText="At least 8 characters and at least two numbers",this.loginPending=!1;return}if(e.get("new_password")!==e.get("password")){this.errorText="Passwords are different",this.loginPending=!1;return}r.append("new_password",e.get("new_password")),r.append("password",e.get("password")),r.append("token",e.get("token")),this.errorText=null,fetch(`${x(this.staging,this.develop)}/api/${this.tenantKey}/set-password`,{method:"POST",body:r,headers:{"Content-Type":"application/x-www-form-urlencoded"}}).then(t=>t.json()).then(t=>{if(t.ok){window.location.href=t.message.redirect_url;return}this.errorText="Something went wrong, try again",n.target.reset()}).catch(console.error).finally(()=>this.loginPending=!1)}render(){return i`<flp-card class="auth-container">
...
//# sourceMappingURL=flp-set-new-password.stories-DZngjrUP.js.map
