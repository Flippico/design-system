...
`;var $=Object.defineProperty,U=Object.getOwnPropertyDescriptor,e=(a,i,n,t)=>{for(var r=t>1?void 0:t?U(i,n):i,m=a.length-1,g;m>=0;m--)(g=a[m])&&(r=(t?g(i,n,r):g(r))||r);return t&&r&&$(i,n,r),r};let o=class extends y{constructor(){super(...arguments),this.tenantKey="",this.logo="",this.signUpUrl="",this.resetPasswordUrl="",this.staging=!1,this.develop=!1,this.mobileLogin=!1,this.loginPending=!1}async loginByGoogle(){window.location.href='bajkomat://login?token="sds"'}async loginByApple(){console.log("login by apple")}async onSubmitHandle(a){a.preventDefault(),this.loginPending=!0;const i=new FormData(a.target);if(Array.from(i.values()).some(t=>t==="")){this.errorText="Password or email is empty",this.loginPending=!1;return}const n=new URLSearchParams;n.append("tenant_key",this.tenantKey),n.append("email",i.get("email")),n.append("password",i.get("password")),this.errorText=null,fetch(`${P(this.staging,this.develop)}/api/${this.tenantKey}/login`,{method:"POST",body:n,headers:{"Content-Type":"application/x-www-form-urlencoded"}}).then(t=>{if(t.ok)return t.json();if(t.status===404)throw this.errorText="User not found",new Error("User not found");if(t.status===403)throw this.errorText="Incorrect password",new Error("Incorrect password")}).then(t=>{window.location.href=t.message.redirect_url}).catch(console.error).finally(()=>this.loginPending=!1)}render(){return p`
    ...
    </flp-card>`}};o.styles=[_];e([l({type:String,attribute:"tenant_key"})],o.prototype,"tenantKey",2);e([l({type:String,attribute:"logo"})],o.prototype,"logo",2);e([l({type:String,attribute:"signup_url"})],o.prototype,"signUpUrl",2);e([l({type:String,attribute:"reset_password_url"})],o.prototype,"resetPasswordUrl",2);e([l({type:Boolean,attribute:"staging"})],o.prototype,"staging",2);e([l({type:Boolean,attribute:"develop"})],o.prototype,"develop",2);e([l({type:Boolean,attribute:"mobile_login"})],o.prototype,"mobileLogin",2);e([b()],o.prototype,"errorText",2);e([b()],o.prototype,"loginPending",2);o=e([w("flp-login")],o);const nt={title:"containers/Login",component:"flp-login"},S={},L=(a,{globals:{theme:i}})=>p`
...
\``,...(u=(f=s.parameters)==null?void 0:f.docs)==null?void 0:u.source}}};const rt=["Default"];export{s as Default,rt as __namedExportsOrder,nt as default};
//# sourceMappingURL=flp-login.stories-DqOxkoyQ.js.map
