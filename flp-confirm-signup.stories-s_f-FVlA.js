import{i as y,x as p}from"./lit-element-UdLzEcH-.js";import{F as b,t as v}from"./custom-element-_dbbq29R.js";import{n as s}from"./property-Cw6hBOl6.js";import{r as h}from"./state-DfeXbQig.js";import{o as f}from"./if-defined-CeGyAtVP.js";import{g as x}from"./get-api-url-BNamD47E.js";/* empty css             */const w=y`
flp-button {
  width: 100%;
}
.error {
...
`;var P=Object.defineProperty,S=Object.getOwnPropertyDescriptor,r=(i,n,a,o)=>{for(var t=o>1?void 0:o?S(n,a):n,m=i.length-1,g;m>=0;m--)(g=i[m])&&(t=(o?g(n,a,t):g(t))||t);return o&&t&&P(n,a,t),t};let e=class extends b{constructor(){super(...arguments),this.tenantKey="",this.token="",this.logo="",this.staging=!1,this.develop=!1,this.loginPending=!1}onSubmitHandle(i){i.preventDefault(),this.loginPending=!0;const n=new FormData(i.target);if(Array.from(n.values()).some(t=>t==="")){this.loginPending=!1;return}const a=new Headers;a.append("Content-Type","application/x-www-form-urlencoded");const o=new URLSearchParams;o.append("token",n.get("token")),o.append("code",n.get("code")),fetch(`${x(this.staging,this.develop)}/api/${this.tenantKey}/confirm-account`,{method:"POST",headers:a,body:o,redirect:"follow"}).then(t=>t.json()).then(t=>{if(t.code<=4e3){window.location.href=t.message.redirect_url;return}this.errorText=JSON.stringify(t.message.error),i.target.reset()}).finally(()=>this.loginPending=!1)}render(){return p`<flp-card class="auth-container">
    ...
    </flp-card>`}};e.styles=[w];r([s({type:String,attribute:"tenant_key"})],e.prototype,"tenantKey",2);r([s({type:String,attribute:"token"})],e.prototype,"token",2);r([s({type:String,attribute:"logo"})],e.prototype,"logo",2);r([s({type:Boolean,attribute:"staging"})],e.prototype,"staging",2);r([s({type:Boolean,attribute:"develop"})],e.prototype,"develop",2);r([h()],e.prototype,"errorText",2);r([h()],e.prototype,"loginPending",2);e=r([v("flp-confirm-signup")],e);const H={title:"containers/ConfirmSignup",component:"flp-confirm-signup"},_={},C=(i,{globals:{theme:n}})=>p`
  <div class="flp-theme-light">
    <flp-confirm-signup>
    </flp-confirm-signup>
  </div>
`,l=C.bind({});l.args=_;var c,d,u;l.parameters={...l.parameters,docs:{...(c=l.parameters)==null?void 0:c.docs,source:{originalSource:`(props: ConfirmSignup, {
  globals: {
    theme
  }
}: {
...
\``,...(u=(d=l.parameters)==null?void 0:d.docs)==null?void 0:u.source}}};const K=["Default"];export{l as Default,K as __namedExportsOrder,H as default};
//# sourceMappingURL=flp-confirm-signup.stories-s_f-FVlA.js.map
