import{i as h,k as b}from"./lit-element-CPYlYYac.js";import{F as y,t as v}from"./custom-element-DcGDOd3C.js";import{n as p}from"./property-CcHbFR6H.js";import{r as k}from"./state-Cw-lAQBx.js";import"./index-fCdhHCjk.js";import{t as c}from"./if-defined-4GS2c12S.js";import{g}from"./get-api-url-BNamD47E.js";/* empty css             */import"./flp-card-CdUiWKie.js";import"./component.styles-MQe3hEw3.js";import"./slot-BCTpRhJ5.js";import"./class-map-635SZfYW.js";import"./index-D-l25SpK.js";import"./commonjsHelpers-Cpj98o6Y.js";import"./flp-button-DKNOhfQI.js";import"./query-BApjzB0v.js";import"./form-DpMOf5Do.js";import"./watch-CEsCE2EF.js";import"./flp-input-DnWocktz.js";import"./form-control.styles-qMh6M_JA.js";import"./live-DyBFC1nW.js";import"./directive-helpers-CHX3h6dV.js";import"./default-value-DEpNiEhc.js";import"./flp-logo-BmvhRZ3J.js";import"./flp-divider-CYuWwxR4.js";const _=h`
flp-button {
  width: 100%;
}
h2 {
...
`;var w=Object.defineProperty,P=Object.getOwnPropertyDescriptor,l=(i,e,t,a)=>{for(var o=a>1?void 0:a?P(e,t):e,r=i.length-1,m;r>=0;r--)(m=i[r])&&(o=(a?m(e,t,o):m(o))||o);return a&&o&&w(e,t,o),o};let n=class extends y{constructor(){super(...arguments),this.tenantKey="",this.loginCallback="",this.logoutCallback="",this.name="",this.staging=!1,this.develop=!1,this.loginPending=!1}onSubmitHandle(i){i.preventDefault(),this.loginPending=!0;const e=new FormData(i.target);if(Array.from(e.values()).some(a=>a==="")){this.loginPending=!1;return}const t=new URLSearchParams;t.append("tenant_key",this.tenantKey),t.append("login_callback",this.loginCallback),t.append("logout_callback",this.logoutCallback),t.append("name",e.get("name")),t.append("email",e.get("email")),t.append("password",e.get("password")),console.log("before"),fetch(`${g(this.staging,this.develop)}/api/${this.tenantKey}/signup`,{method:"POST",body:t,headers:{"Content-Type":"application/x-www-form-urlencoded"}}).then(a=>{console.log(a),window.location.href=`${g(this.staging,this.develop)}/${this.tenantKey}/login`}).finally(()=>this.loginPending=!1)}render(){return b`<flp-card class="auth-container">
      <form @submit=${this.onSubmitHandle}>
        ...
        <div class="login-container">
          ...
          <flp-button class="login--button" variant="text" href=${`${g(this.staging,this.develop)}/${this.tenantKey}/login`}>Login</flp-button>
        </div>
      </form>
...
//# sourceMappingURL=flp-signup.stories-BAFB_UgU.js.map
