...
`;var P=Object.defineProperty,w=Object.getOwnPropertyDescriptor,a=(o,e,t,i)=>{for(var l=i>1?void 0:i?w(e,t):e,s=o.length-1,m;s>=0;s--)(m=o[s])&&(l=(i?m(e,t,l):m(l))||l);return i&&l&&P(e,t,l),l};let n=class extends y{constructor(){super(...arguments),this.tenantKey="",this.loginCallback="",this.logoutCallback="",this.name="",this.staging=!1,this.develop=!1,this.loginPending=!1}onSubmitHandle(o){o.preventDefault(),this.loginPending=!0;const e=new FormData(o.target);if(Array.from(e.values()).some(i=>i==="")){this.loginPending=!1;return}const t=new URLSearchParams;t.append("tenant_key",this.tenantKey),t.append("login_callback",this.loginCallback),t.append("logout_callback",this.logoutCallback),t.append("name",e.get("name")),t.append("email",e.get("email")),t.append("password",e.get("password")),fetch(`${c(this.staging,this.develop)}/api/${this.tenantKey}/signup`,{method:"POST",body:t,headers:{"Content-Type":"application/x-www-form-urlencoded"}}).finally(()=>this.loginPending=!1)}render(){return b`<flp-card class="auth-container">
    ...
    </flp-card>`}};n.styles=[_];a([p({type:String,attribute:"tenant_key"})],n.prototype,"tenantKey",2);a([p({type:String,attribute:"login_callback"})],n.prototype,"loginCallback",2);a([p({type:String,attribute:"logout_callback"})],n.prototype,"logoutCallback",2);a([p({type:String,attribute:"name"})],n.prototype,"name",2);a([p({type:Boolean,attribute:"staging"})],n.prototype,"staging",2);a([p({type:Boolean,attribute:"develop"})],n.prototype,"develop",2);a([k()],n.prototype,"loginPending",2);n=a([v("flp-signup")],n);const X={title:"containers/Signup",component:"flp-signup"},x={},S=(o,{globals:{theme:e}})=>b`
...
//# sourceMappingURL=flp-signup.stories-BkH-2jPx.js.map
