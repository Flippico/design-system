import{i as k,k as a}from"./lit-element-CPYlYYac.js";import{F as x,t as v}from"./custom-element-DcGDOd3C.js";import{n as i}from"./property-CcHbFR6H.js";import{r as g}from"./state-Cw-lAQBx.js";import{e as y}from"./query-BApjzB0v.js";import{c as _}from"./component.styles-MQe3hEw3.js";import{F as C}from"./form-DpMOf5Do.js";import{d as z}from"./default-value-DEpNiEhc.js";import{w as m}from"./watch-CEsCE2EF.js";import{t as F}from"./if-defined-4GS2c12S.js";import{F as p}from"./live-DyBFC1nW.js";import{R as $}from"./class-map-635SZfYW.js";/* empty css             */import"./directive-helpers-CHX3h6dV.js";const w=k`
${_}
...
`;var V=Object.defineProperty,q=Object.getOwnPropertyDescriptor,o=(t,r,s,n)=>{for(var c=n>1?void 0:n?q(r,s):r,h=t.length-1,d;h>=0;h--)(d=t[h])&&(c=(n?d(r,s,c):d(c))||c);return n&&c&&V(r,s,c),c};let e=class extends x{constructor(){super(...arguments),this.formControlController=new C(this,{value:t=>t.checked?t.value||"on":void 0,defaultValue:t=>t.defaultChecked,setValue:(t,r)=>t.checked=r}),this.hasFocus=!1,this.title="",this.name="",this.size="medium",this.disabled=!1,this.checked=!1,this.indeterminate=!1,this.defaultChecked=!1,this.form="",this.required=!1}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleClick(){this.checked=!this.checked,this.indeterminate=!1,this.emit("flp-change")}handleBlur(){this.hasFocus=!1,this.emit("flp-blur")}handleInput(){this.emit("flp-input")}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}handleFocus(){this.hasFocus=!0,this.emit("flp-focus")}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleStateChange(){this.input.checked=this.checked,this.input.indeterminate=this.indeterminate,this.formControlController.updateValidity()}click(){this.input.click()}focus(t){this.input.focus(t)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(t){this.input.setCustomValidity(t),this.formControlController.updateValidity()}render(){return a`
    ...
    `}};e.styles=[w];o([y('input[type="checkbox"]')],e.prototype,"input",2);o([g()],e.prototype,"hasFocus",2);o([i()],e.prototype,"title",2);o([i()],e.prototype,"name",2);o([i()],e.prototype,"value",2);o([i({reflect:!0})],e.prototype,"size",2);o([i({type:Boolean,reflect:!0})],e.prototype,"disabled",2);o([i({type:Boolean,reflect:!0})],e.prototype,"checked",2);o([i({type:Boolean,reflect:!0})],e.prototype,"indeterminate",2);o([z("checked")],e.prototype,"defaultChecked",2);o([i({reflect:!0})],e.prototype,"form",2);o([i({type:Boolean,reflect:!0})],e.prototype,"required",2);o([m("disabled",{waitUntilFirstUpdate:!0})],e.prototype,"handleDisabledChange",1);o([m(["checked","indeterminate"],{waitUntilFirstUpdate:!0})],e.prototype,"handleStateChange",1);e=o([v("flp-checkbox")],e);const K={title:"components/Checkbox",component:"flp-checkbox"},D={},B=(t,{globals:{theme:r}})=>a`
...
\``,...(b=(u=l.parameters)==null?void 0:u.docs)==null?void 0:b.source}}};const L=["Default"];export{l as Default,L as __namedExportsOrder,K as default};
//# sourceMappingURL=flp-checkbox.stories-BtKcpFIp.js.map
