import{i as x,x as d}from"./lit-element-BOnOm6HC.js";import{F as C,t as A}from"./custom-element-G_of5crQ.js";import{n}from"./property-DtfuD-FT.js";import{e as S}from"./query-BApjzB0v.js";import{c as k}from"./component.styles-BRPzpB69.js";import{H}from"./slot-BCTpRhJ5.js";import{w as _}from"./watch-CEsCE2EF.js";import{b as w,s as h,g as m,a as u,w as v}from"./event-DI7budSv.js";import{a as D}from"./class-map-CkhaUZsQ.js";import"./flp-icon-RHbQcKsa.js";/* empty css             */import"./state-BzG7ktrc.js";import"./directive-helpers-Ew8efCbj.js";const O=x`
${k}
...
`;var T=Object.defineProperty,F=Object.getOwnPropertyDescriptor,a=(t,r,p,s)=>{for(var o=s>1?void 0:s?F(r,p):r,c=t.length-1,f;c>=0;c--)(f=t[c])&&(o=(s?f(r,p,o):f(o))||o);return s&&o&&T(r,p,o),o};const l=Object.assign(document.createElement("div"),{className:"flp-toast-stack"});let e=class extends C{constructor(){super(...arguments),this.hasSlotController=new H(this,"icon","suffix"),this.open=!1,this.closable=!1,this.variant="primary",this.duration=1/0}firstUpdated(){this.base.hidden=!this.open}restartAutoHide(){clearTimeout(this.autoHideTimeout),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.duration))}handleCloseClick(){this.hide()}handleMouseMove(){this.restartAutoHide()}async handleOpenChange(){if(this.open){this.emit("flp-show"),this.duration<1/0&&this.restartAutoHide(),await h(this.base),this.base.hidden=!1;const{keyframes:t,options:r}=m(this,"alert.show",{dir:"ltr"});await u(this.base,t,r),this.emit("flp-after-show")}else{this.emit("flp-hide"),clearTimeout(this.autoHideTimeout),await h(this.base);const{keyframes:t,options:r}=m(this,"alert.hide",{dir:"ltr"});await u(this.base,t,r),this.base.hidden=!0,this.emit("flp-after-hide")}}handleDurationChange(){this.restartAutoHide()}async show(){if(!this.open)return this.open=!0,v(this,"flp-after-show")}async hide(){if(this.open)return this.open=!1,v(this,"flp-after-hide")}async toast(){return new Promise(t=>{l.parentElement===null&&document.body.append(l),l.appendChild(this),requestAnimationFrame(()=>{this.clientWidth,this.show()}),this.addEventListener("flp-after-hide",()=>{l.removeChild(this),t(),l.querySelector("flp-alert")===null&&l.remove()},{once:!0})})}render(){return d`
      <div
        part="base"
    ...
    `}};e.styles=[O];a([S('[part~="base"]')],e.prototype,"base",2);a([n({type:Boolean,reflect:!0})],e.prototype,"open",2);a([n({type:Boolean,reflect:!0})],e.prototype,"closable",2);a([n({reflect:!0})],e.prototype,"variant",2);a([n({type:Number})],e.prototype,"duration",2);a([_("open",{waitUntilFirstUpdate:!0})],e.prototype,"handleOpenChange",1);a([_("duration")],e.prototype,"handleDurationChange",1);e=a([A("flp-alert")],e);w("alert.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}});w("alert.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}});const J={title:"components/Alert",component:"flp-alert"},$={},z=(t,{globals:{theme:r}})=>d`
...
//# sourceMappingURL=flp-alert.stories-lFnzCTUo.js.map
