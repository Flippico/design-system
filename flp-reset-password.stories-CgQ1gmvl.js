import{i as w,x as a}from"./lit-element-UdLzEcH-.js";import{F as b,t as y}from"./custom-element-_dbbq29R.js";import{n as p}from"./property-Cw6hBOl6.js";import{r as g}from"./state-DfeXbQig.js";import"./index-B6wvuWEg.js";import{g as x}from"./get-api-url-BNamD47E.js";import{o as c}from"./if-defined-CeGyAtVP.js";/* empty css             */import"./flp-icon-D5FDkxOg.js";import"./component.styles-BhDG6Xff.js";import"./watch-CEsCE2EF.js";import"./directive-helpers-gF-rCVue.js";import"./index-D2NdRWdU.js";import"./commonjsHelpers-Cpj98o6Y.js";import"./create-component-DR4KZdWz.js";const v=w`
.auth-container {
  max-width: 450px;
  width: 100%;
}
...
}`;var P=Object.defineProperty,_=Object.getOwnPropertyDescriptor,r=(s,o,i,t)=>{for(var n=t>1?void 0:t?_(o,i):o,m=s.length-1,d;m>=0;m--)(d=s[m])&&(n=(t?d(o,i,n):d(n))||n);return t&&n&&P(o,i,n),n};let e=class extends b{constructor(){super(...arguments),this.tenantKey="",this.logo="",this.staging=!1,this.develop=!1,this.loginPending=!1,this.successState=!1}async onSubmitHandle(s){s.preventDefault(),this.loginPending=!0;const o=new FormData(s.target);if(Array.from(o.values()).some(t=>t==="")){this.errorText="Email is empty",this.loginPending=!1;return}const i=new URLSearchParams;i.append("email",o.get("email")),this.errorText=null,fetch(`${x(this.staging,this.develop)}/api/${this.tenantKey}/reset-password`,{method:"POST",body:i,headers:{"Content-Type":"application/x-www-form-urlencoded"}}).then(t=>t.json()).then(t=>{if(t.ok){window.location.href=t.message.redirect_url;return}this.errorText="Something went wrong, try again",s.target.reset()}).catch(console.error).finally(()=>this.loginPending=!1)}render(){return a`<flp-card class="auth-container">
...
//# sourceMappingURL=flp-reset-password.stories-CgQ1gmvl.js.map
