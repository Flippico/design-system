...
`;var $=Object.defineProperty,U=Object.getOwnPropertyDescriptor,e=(a,i,l,t)=>{for(var n=t>1?void 0:t?U(i,l):i,m=a.length-1,g;m>=0;m--)(g=a[m])&&(n=(t?g(i,l,n):g(n))||n);return t&&n&&$(i,l,n),n};let o=class extends y{constructor(){super(...arguments),this.tenantKey="",this.logo="",this.signUpUrl="",this.resetPasswordUrl="",this.staging=!1,this.develop=!1,this.mobileLogin=!1,this.loginPending=!1}async loginByGoogle(){window.location.href='bajkomat://login?token="sds"'}async loginByApple(){console.log("login by apple")}async onSubmitHandle(a){a.preventDefault(),this.loginPending=!0;const i=new FormData(a.target);if(Array.from(i.values()).some(t=>t==="")){this.errorText="Password or email is empty",this.loginPending=!1;return}const l=new URLSearchParams;l.append("tenant_key",this.tenantKey),l.append("email",i.get("email")),l.append("password",i.get("password")),this.errorText=null,fetch(`${P(this.staging,this.develop)}/api/${this.tenantKey}/login`,{method:"POST",body:l,headers:{"Content-Type":"application/x-www-form-urlencoded"}}).then(t=>t.json()).then(t=>{if(console.log("response",t),t.ok){window.location.href=t.message.redirect_url;return}t.status===404&&(this.errorText="User not found"),t.status===403&&(this.errorText="Incorrect password")}).catch(console.error).finally(()=>this.loginPending=!1)}render(){return p`
...
//# sourceMappingURL=flp-login.stories-DLDHtdIP.js.map
