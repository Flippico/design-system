...
`;var k=Object.defineProperty,P=Object.getOwnPropertyDescriptor,n=(i,t,o,s)=>{for(var l=s>1?void 0:s?P(t,o):t,p=i.length-1,g;p>=0;p--)(g=i[p])&&(l=(s?g(t,o,l):g(l))||l);return s&&l&&k(t,o,l),l};let e=class extends y{constructor(){super(...arguments),this.tenantKey="",this.loginCallback="",this.logoutCallback="",this.name="",this.staging=!1,this.develop=!1,this.loginPending=!1}onSubmitHandle(i){i.preventDefault(),this.loginPending=!0;const t=new FormData(i.target);if(Array.from(t.values()).some(o=>o==="")){this.loginPending=!1;return}console.log("email",t.get("email")),console.log("password",t.get("password")),console.log("name",t.get("name")),console.log("tenant-key",t.get("tenant-key")),console.log("login-callback",t.get("login-callback")),console.log("logout-callback",t.get("logout-callback")),fetch(`${c(this.staging,this.develop)}/${t.get("tenant-key")}/signup`,{method:"POST",body:t}).then(o=>o.json()).then(o=>{window.location.replace(`${this.loginCallback}/api/${o.message.token}`)}).finally(()=>this.loginPending=!1)}render(){return b`<flp-card class="auth-container">
