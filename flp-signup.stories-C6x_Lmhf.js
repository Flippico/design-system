import{i as h,k as b}from"./lit-element-CPYlYYac.js";import{F as y,t as v}from"./custom-element-DcGDOd3C.js";import{n as i}from"./property-CcHbFR6H.js";import{r as k}from"./state-Cw-lAQBx.js";import"./index-fCdhHCjk.js";import{t as g}from"./if-defined-4GS2c12S.js";import{g as c}from"./get-api-url-BNamD47E.js";/* empty css             */import"./flp-card-CdUiWKie.js";import"./component.styles-MQe3hEw3.js";import"./slot-BCTpRhJ5.js";import"./class-map-635SZfYW.js";import"./index-D-l25SpK.js";import"./commonjsHelpers-Cpj98o6Y.js";import"./flp-button-DKNOhfQI.js";import"./query-BApjzB0v.js";import"./form-DpMOf5Do.js";import"./watch-CEsCE2EF.js";import"./flp-input-DnWocktz.js";import"./form-control.styles-qMh6M_JA.js";import"./live-DyBFC1nW.js";import"./directive-helpers-CHX3h6dV.js";import"./default-value-DEpNiEhc.js";import"./flp-logo-BmvhRZ3J.js";import"./flp-divider-CYuWwxR4.js";const _=h`
flp-button {
  width: 100%;
}
h2 {
...
`;var P=Object.defineProperty,x=Object.getOwnPropertyDescriptor,l=(a,e,n,s)=>{for(var o=s>1?void 0:s?x(e,n):e,r=a.length-1,m;r>=0;r--)(m=a[r])&&(o=(s?m(e,n,o):m(o))||o);return s&&o&&P(e,n,o),o};let t=class extends y{constructor(){super(...arguments),this.tenantKey="",this.loginCallback="",this.logoutCallback="",this.name="",this.staging=!1,this.develop=!1,this.loginPending=!1}onSubmitHandle(a){a.preventDefault(),this.loginPending=!0;const e=new FormData(a.target);if(console.log("this.tenantKey",this.tenantKey),console.log("formData",e.get("tenant_key")),Array.from(e.values()).some(n=>n==="")){this.loginPending=!1;return}fetch(`${c(this.staging,this.develop)}/api/${this.tenantKey}/signup`,{method:"POST",body:e}).then(n=>n.json()).then(n=>{window.location.replace(`${this.loginCallback}/api/${n.message.token}`)}).finally(()=>this.loginPending=!1)}render(){return b`<flp-card class="auth-container">
    ...
    </flp-card>`}};t.styles=[_];l([i({type:String,attribute:"tenant_key"})],t.prototype,"tenantKey",2);l([i({type:String,attribute:"login_callback"})],t.prototype,"loginCallback",2);l([i({type:String,attribute:"logout_callback"})],t.prototype,"logoutCallback",2);l([i({type:String,attribute:"name"})],t.prototype,"name",2);l([i({type:Boolean,attribute:"staging"})],t.prototype,"staging",2);l([i({type:Boolean,attribute:"develop"})],t.prototype,"develop",2);l([k()],t.prototype,"loginPending",2);t=l([v("flp-signup")],t);const X={title:"containers/Signup",component:"flp-signup"},$={},w=(a,{globals:{theme:e}})=>b`
...
//# sourceMappingURL=flp-signup.stories-C6x_Lmhf.js.map
