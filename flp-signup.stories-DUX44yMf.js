...
`;var P=Object.defineProperty,w=Object.getOwnPropertyDescriptor,l=(i,n,e,r)=>{for(var a=r>1?void 0:r?w(n,e):n,s=i.length-1,m;s>=0;s--)(m=i[s])&&(a=(r?m(n,e,a):m(a))||a);return r&&a&&P(n,e,a),a};let t=class extends y{constructor(){super(...arguments),this.tenantKey="",this.loginCallback="",this.logoutCallback="",this.name="",this.staging=!1,this.develop=!1,this.loginPending=!1}onSubmitHandle(i){i.preventDefault(),this.loginPending=!0;const n=new FormData(i.target);if(Array.from(n.values()).some(e=>e==="")){this.loginPending=!1;return}fetch(`${c(this.staging,this.develop)}/api/${this.tenantKey}/signup`,{method:"POST",body:n,headers:{"Content-Type":"application/x-www-form-urlencoded"}}).then(e=>e.json()).then(e=>{window.location.replace(`${this.loginCallback}/api/${e.message.token}`)}).finally(()=>this.loginPending=!1)}render(){return b`<flp-card class="auth-container">
...
`,p=$.bind({});p.args=x;var u,d,f;p.parameters={...p.parameters,docs:{...(u=p.parameters)==null?void 0:u.docs,source:{originalSource:`(props: Signup, {
  globals: {
    theme
  }
}: {
...
//# sourceMappingURL=flp-signup.stories-DUX44yMf.js.map
