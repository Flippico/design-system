import{H as x}from"./slot-BCTpRhJ5.js";import{F as w,t as k}from"./custom-element-G_of5crQ.js";import{n}from"./property-DtfuD-FT.js";import{r as y}from"./state-BzG7ktrc.js";import{e as $}from"./query-BApjzB0v.js";import{i as C,x as B}from"./lit-element-BOnOm6HC.js";import{c as F}from"./component.styles-BRPzpB69.js";import{F as S,v as z}from"./form-JvG0YwJe.js";import{o as b}from"./if-defined-4aLJvHj9.js";import{w as V}from"./watch-CEsCE2EF.js";import{a as D}from"./class-map-CkhaUZsQ.js";const P=C`
  ${F}
 ...
 */const _=Symbol.for(""),O=t=>{if((t==null?void 0:t.r)===_)return t==null?void 0:t._$litStatic$},v=(t,...l)=>({_$litStatic$:l.reduce((u,e,a)=>u+(i=>{if(i._$litStatic$!==void 0)return i._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${i}. Use 'unsafeStatic' to pass non-literal values, but
    ...
    `}};o.styles=[P];r([$(".button")],o.prototype,"button",2);r([y()],o.prototype,"hasFocus",2);r([y()],o.prototype,"invalid",2);r([n()],o.prototype,"title",2);r([n({reflect:!0})],o.prototype,"variant",2);r([n({reflect:!0})],o.prototype,"size",2);r([n({type:Boolean,reflect:!0})],o.prototype,"caret",2);r([n({type:Boolean,reflect:!0})],o.prototype,"disabled",2);r([n({type:Boolean,reflect:!0})],o.prototype,"loading",2);r([n({type:Boolean,reflect:!0})],o.prototype,"outline",2);r([n({type:Boolean,reflect:!0})],o.prototype,"pill",2);r([n({type:Boolean,reflect:!0})],o.prototype,"circle",2);r([n()],o.prototype,"type",2);r([n()],o.prototype,"name",2);r([n()],o.prototype,"value",2);r([n()],o.prototype,"href",2);r([n()],o.prototype,"target",2);r([n()],o.prototype,"rel",2);r([n()],o.prototype,"download",2);r([n()],o.prototype,"form",2);r([n({attribute:"formaction"})],o.prototype,"formAction",2);r([n({attribute:"formenctype"})],o.prototype,"formEnctype",2);r([n({attribute:"formmethod"})],o.prototype,"formMethod",2);r([n({attribute:"formnovalidate",type:Boolean})],o.prototype,"formNoValidate",2);r([n({attribute:"formtarget"})],o.prototype,"formTarget",2);r([V("disabled",{waitUntilFirstUpdate:!0})],o.prototype,"handleDisabledChange",1);o=r([k("flp-button")],o);export{o as F};
//# sourceMappingURL=flp-button-BUnE6aW6.js.map
