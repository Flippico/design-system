import{i as k,k as b}from"./lit-element-CPYlYYac.js";import{l as y}from"./index-fCdhHCjk.js";import{F as x,t as w}from"./custom-element-DcGDOd3C.js";import{n as a}from"./property-CcHbFR6H.js";import{r as h}from"./state-Cw-lAQBx.js";import{F as $}from"./flp-icon-MB4vJ9eU.js";import{a as v}from"./index-D-l25SpK.js";import{F as P}from"./flp-spinner-y5zgyz0m.js";import{t as c}from"./if-defined-4GS2c12S.js";import{g as m}from"./get-api-url-DU-JDYJT.js";/* empty css             */import"./flp-card-CdUiWKie.js";import"./component.styles-MQe3hEw3.js";import"./slot-BCTpRhJ5.js";import"./class-map-635SZfYW.js";import"./flp-button-DKNOhfQI.js";import"./query-BApjzB0v.js";import"./form-DpMOf5Do.js";import"./watch-CEsCE2EF.js";import"./flp-input-DnWocktz.js";import"./form-control.styles-qMh6M_JA.js";import"./live-DyBFC1nW.js";import"./directive-helpers-CHX3h6dV.js";import"./default-value-DEpNiEhc.js";import"./flp-logo-BmvhRZ3J.js";import"./flp-divider-CYuWwxR4.js";import"./commonjsHelpers-Cpj98o6Y.js";y({tagName:"flp-icon",elementClass:$,react:v,events:{},displayName:"FlpIcon"});y({tagName:"flp-spinner",elementClass:P,react:v,events:{},displayName:"FlpSpinner"});const _=k`
...
`;var C=Object.defineProperty,F=Object.getOwnPropertyDescriptor,l=(n,t,o,s)=>{for(var i=s>1?void 0:s?F(t,o):t,p=n.length-1,g;p>=0;p--)(g=n[p])&&(i=(s?g(t,o,i):g(i))||i);return s&&i&&C(t,o,i),i};let e=class extends x{constructor(){super(...arguments),this.tenantKey="",this.loginCallback="",this.logoutCallback="",this.name="",this.staging=!1,this.develop=!1,this.loginPending=!1}async loginByGoogle(){console.log("login by google")}async loginByApple(){console.log("login by apple")}async onSubmitHandle(n){n.preventDefault(),this.loginPending=!0;const t=new FormData(n.target);if(Array.from(t.values()).some(o=>o==="")){this.errorText="Password or email is empty",this.loginPending=!1;return}console.log("email",t.get("email")),console.log("password",t.get("password")),console.log("tenant-key",t.get("tenant-key")),console.log("login-callback",t.get("login-callback")),console.log("logout-callback",t.get("logout-callback")),this.errorText=null,fetch(`${m(this.staging,this.develop)}/api/${t.get("tenant-key")}/login`,{method:"POST",body:t}).then(o=>o.json()).then(o=>{window.location.replace(`${this.loginCallback}/${o.message.token}`)}).catch(()=>this.errorText="Error while send to API").finally(()=>this.loginPending=!1)}render(){return b`
...
//# sourceMappingURL=flp-login.stories-BloZPj-I.js.map
