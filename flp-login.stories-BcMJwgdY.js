...
`;var $=Object.defineProperty,S=Object.getOwnPropertyDescriptor,i=(r,o,l,e)=>{for(var n=e>1?void 0:e?S(o,l):o,g=r.length-1,m;g>=0;g--)(m=r[g])&&(n=(e?m(o,l,n):m(n))||n);return e&&n&&$(o,l,n),n};let t=class extends y{constructor(){super(...arguments),this.tenantKey="",this.logo="",this.signUpUrl="",this.resetPasswordUrl="",this.staging=!1,this.develop=!1,this.mobileLogin=!1,this.loginPending=!1}async loginByGoogle(){console.log("login by google")}async loginByApple(){console.log("login by apple")}async onSubmitHandle(r){r.preventDefault(),this.loginPending=!0;const o=new FormData(r.target);if(Array.from(o.values()).some(e=>e==="")){this.errorText="Password or email is empty",this.loginPending=!1;return}const l=new URLSearchParams;l.append("tenant_key",this.tenantKey),l.append("name",o.get("name")),l.append("email",o.get("email")),l.append("password",o.get("password")),this.errorText=null,fetch(`${P(this.staging,this.develop)}/api/${this.tenantKey}/login`,{method:"POST",body:l,headers:{"Content-Type":"application/x-www-form-urlencoded"}}).then(e=>e.json()).then(e=>{window.location.href=`${e.message.redirect_url}?token=${e.message.token}`}).catch(console.error).finally(()=>this.loginPending=!1)}render(){return p`
...
//# sourceMappingURL=flp-login.stories-BcMJwgdY.js.map
