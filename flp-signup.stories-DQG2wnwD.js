...
`;var P=Object.defineProperty,_=Object.getOwnPropertyDescriptor,n=(i,e,a,r)=>{for(var t=r>1?void 0:r?_(e,a):e,m=i.length-1,g;m>=0;m--)(g=i[m])&&(t=(r?g(e,a,t):g(t))||t);return r&&t&&P(e,a,t),t};let o=class extends y{constructor(){super(...arguments),this.tenantKey="",this.logo="",this.loginUrl="",this.staging=!1,this.develop=!1,this.useEvent=!1,this.loginPending=!1}onSubmitHandle(i){i.preventDefault(),this.loginPending=!0;const e=new FormData(i.target);if(Array.from(e.values()).some(t=>t==="")){this.loginPending=!1;return}if(!/^(?=.*\d.*\d)[A-Za-z\d!@#$%^&*()_+\-=[\]{};':",.<>?\/]{6,}$/.test(e.get("password"))){this.errorText="At least 8 characters and at least two numbers",this.loginPending=!1;return}this.errorText=null;const a=new Headers;a.append("Content-Type","application/x-www-form-urlencoded");const r=new URLSearchParams;r.append("name",e.get("name")),r.append("email",e.get("email")),r.append("password",e.get("password")),fetch(`${w(this.staging,this.develop)}/api/${this.tenantKey}/signup`,{method:"POST",body:r,headers:a}).then(t=>{if(t.ok)return t.json();if(t.status===403)throw this.errorText="User already exist",i.target.reset(),new Error("User already exist")}).then(t=>{if(this.useEvent){this.emit("flp-signup-success",t.message);return}window.location.href=t.message.redirect_url}).catch(console.error).finally(()=>this.loginPending=!1)}render(){return p`<flp-card class="auth-container">
    ...
    </flp-card>`}};o.styles=[x];n([l({type:String,attribute:"tenant_key"})],o.prototype,"tenantKey",2);n([l({type:String,attribute:"logo"})],o.prototype,"logo",2);n([l({type:String,attribute:"login_url"})],o.prototype,"loginUrl",2);n([l({type:Boolean,attribute:"staging"})],o.prototype,"staging",2);n([l({type:Boolean,attribute:"develop"})],o.prototype,"develop",2);n([l({type:Boolean,attribute:"use_event"})],o.prototype,"useEvent",2);n([h()],o.prototype,"errorText",2);n([h()],o.prototype,"loginPending",2);o=n([v("flp-signup")],o);const X={title:"containers/Signup",component:"flp-signup"},S={},$=(i,{globals:{theme:e}})=>p`
...
`,s=$.bind({});s.args=S;var c,d,f;s.parameters={...s.parameters,docs:{...(c=s.parameters)==null?void 0:c.docs,source:{originalSource:`(props: Signup, {
  globals: {
    theme
  }
}: {
...
//# sourceMappingURL=flp-signup.stories-DQG2wnwD.js.map
